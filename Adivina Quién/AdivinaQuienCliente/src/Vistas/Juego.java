...
public class Juego extends javax.swing.JFrame {
    ...
    //private Thread hilo4 = new Thread(this);
    private Tiempo tp;
    ...
    private void initComponents() {
        ...
        jLabel6.setBounds(650, 40, 50, 40);

        jLabel5.setFont(new java.awt.Font("Comic Sans MS", 1, 18)); // NOI18N
        jLabel5.setForeground(new java.awt.Color(204, 0, 0));
        jLabel5.setText("TIEMPO");
        getContentPane().add(jLabel5);
        jLabel5.setBounds(630, 30, 80, 26);
        ...
        jLabel7.setBounds(600, 10, 41, 16);
    ...
    public void run() {            
        while(true) {
            try {
                    ...
                    Vistas.Juego.AreaChat.append(text + "\n");
                
            } catch(Exception e) {
                System.out.println("ERROR EN EL HILO JUEGO");
            }    
        }        
    }*/
}